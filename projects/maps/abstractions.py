...
def user_reviewed_restaurants(user, restaurants): # restaurants is a list of all restaurants 
...
def restaurant_num_ratings(restaurant):
    ...
    # BEGIN Question 2
    all_ratings = restaurant_ratings(restaurant)
...
def restaurant_mean_rating(restaurant):
    ...
    return sum(all_ratings) / num_ratings
    # END Question 2