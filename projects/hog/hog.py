...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 2
    # one higher orfer function can get rid of those two score = statements. Build it maybe? 
    if num_rolls == 0:
...
def check_strategy(strategy, goal=GOAL_SCORE):
    ...
    """
    # BEGIN PROBLEM 6
    # So, we just give all possible inputs to the strategy function,
    # and test all the outputs. 
